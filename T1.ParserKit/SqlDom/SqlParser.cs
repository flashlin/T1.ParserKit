...
namespace T1.ParserKit.SqlDom
{
	public class SqlParser
	{
		...
		{
			//var filter1 = FilterExpr(Atom);

			//var statements0 = factor.Many(0, 0)
			//	.MapResult(x => new ManySqlExpression()
			//	{
			//		Items = new ITextSpan[] {
			//			new StatementsExpression()
			//			{
			//				Items = new SqlExpression[0]
			//			},
			//			new ManySqlExpression()
			//			{
			//				Items = new ITextSpan[0]
			//			}
			//		}
			//	});

			//var statements1 = factor.AtLeastOnce()
			//	.MapResult(x => new ManySqlExpression()
			//	{
			//		Items = new ITextSpan[] {
			//			new StatementsExpression()
			...
			//		}
			//	});
			//var if1 = Parse.Chain(Match("IF"), filter1, Match("BEGIN"))
			...
			//		Items = x.ToArray()
			//	});
			//var manyEnd = Match("END").Many(1)
			//	.MapResult(x => new ManySqlExpression()
			//	{
			//		Items = x.ToArray()
			//	});
			//var statements2 = Parse.Chain(statements1, manyEnd)
			//	.MapResult(x => new ManySqlExpression()
			//	{
			//		Items = x.ToArray()
			//	});

			//var statements3 = Parse.Any(
			//	statements2,
			//	statements1,
			//	statements0);

			//var last = Parse.Chain(
			//	manyIf,
			//	statements3,
			//	Match("END"))
			//	.RemapResult((inp, rc) =>
			//	{
			//		var statementsExpr = new StatementsExpression();

			//		var ifArr = (ManySqlExpression)rc.Result[0];
			//		var many = (ManySqlExpression)rc.Result[1];
			//		var statements = (ManySqlExpression) many.Items[0];
			//		var endArr = (ManySqlExpression)many.Items[1];

			//		var if0 = (IfExpression)ifArr.Items[0];
			//		if0.CopyTextSpan(rc.Result);

			//		return Parse.Success(if0, rc.Rest);
			//	});
